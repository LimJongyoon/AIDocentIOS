...
class SearchViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate {
    ...
    override func viewDidLoad() {
        ...
        // 디바이스 정보를 설정
        deviceInfo = [
            "MMCA001": ("우제류를 위하여", "신현중(1995)", "195x155x45mm", "청동", "신현중(1953- )의 <뿔 있는 우제류를 위하여>(1995)는 인류 문명의 원형에 대한 탐구를 우제류 연작을 통하여 형상화한 작품이다."),
            "MMCA002": ("마두", "권진규(1952)", "31.4×64.2×15.6mm", "안산암", "권진규(권진규, 1922-1973)는 함경남도 함흥에서 태어났다."),
            "MMCA003": ("트리", "권오상(2013)", "274x184x167mm", "종이,에폭시,폴리스티렌", "소조는 무언가를 붙여서 형태를 만드는 것이다."),
